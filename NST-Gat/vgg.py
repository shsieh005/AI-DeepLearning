...
class Vgg16(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, show_progress=False):
        ...
        self.content_feature_maps_index = 1  # relu2_2 (which layer is being used, extracts lower level features, if higher level ex: 4, only extract semantically meaningful, abstract information)
